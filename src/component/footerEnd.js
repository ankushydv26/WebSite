    ...
    return (
      <div>
        <Row lg="12" sm="12" md="12">
          <Col md="4">
            <div className="footer-contact" style={{ paddingLeft: "80px" }}>
              ...
              <div className="footer-call-us">
                <div className="media">
                  ...
                  <div className="media-body" style={{ paddingTop: "20px" }}>
                    {" "}
                    <span
                      className="call-us-text"
                      style={{ paddingTop: "20px" }}
                    >
                      Got Questions ? Call us 24/7!
                    </span>{" "}
                    <span
                      className="call-us-number"
                      style={{ paddingTop: "20px" }}
                    >
              ...
              <div className="footer-address" style={{ paddingTop: "20px" }}>
                {" "}
          ...
          <Col md="2">
            <div className="columns">
              ...
              >
                <div className="body">
                  <h4 className="widget-title" style={{ paddingLeft: "40px" }}>
                    Find It Fast
                  </h4>
                  <div className="menu-footer-menu-1-container">
                    ...
                    >
                      <li id="menu-item-5281" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/product-category/laptops-computers/">
                          Laptops &amp; Computers
                        </a>
                      </li>
                      <li id="menu-item-5282" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/product-category/cameras-photography/">
                          Cameras &amp; Photography
                        </a>
                      </li>
                      <li id="menu-item-5283" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/product-category/smart-phones-tablets/">
                          Smart Phones &amp; Tablets
                        </a>
                      </li>
                      <li id="menu-item-5284" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/product-category/video-games-consoles/">
                          Video Games &amp; Consoles
                        </a>
                      </li>
                      <li id="menu-item-5285" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/product-category/tv-audio/">
                          TV &amp; Audio
                        </a>
                      </li>
                      <li id="menu-item-5286" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/product-category/gadgets/">
                          Gadgets
                        </a>
                      </li>
                      <li id="menu-item-5287" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/product-category/accessories/headphones/waterproof-headphones/">
                ...
                <div className="body">
                  ...
                  <div className="menu-footer-menu-2-container">
                    <ul
                      ...
                      style={{ listStyle: "none" }}
                    >
                      <li id="menu-item-5399" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/about/">
                          About
                        </a>
                      </li>
                      <li id="menu-item-5397" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/contact-v1/">
                          Contact
                        </a>
                      </li>
                      <li id="menu-item-5414" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/wishlist/">
                          Wishlist
                        </a>
                      </li>
                      <li id="menu-item-5415" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/compare/">
                          Compare
                        </a>
                      </li>
                      <li id="menu-item-5398" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/faq/">
                          FAQ
                        </a>
                      </li>
                      <li id="menu-item-5416" className="listf">
                        <a href="https://demo3.madrasthemes.com/electro/v2/store-directory/">
                          Store Directory
                        </a>
                      </li>
                    </ul>
              ...
              <aside id="nav_menu-3" class="widget clearfix widget_nav_menu">
                <div class="body">
                  ...
                  <div class="menu-footer-menu-3-container">
                    <ul id="menu-footer-menu-3" class="menu" style={{ listStyle: "none" }}>
                      <li
                        id="menu-item-5303"
                        className="listf"
                      >
                        <a href="https://demo3.madrasthemes.com/electro/v2/my-account/">
                          My Account
                        </a>
                      </li>
                      <li
                        ...
                        className="listf"
                      >
                        <a href="https://demo3.madrasthemes.com/electro/v2/track-your-order/">
                          Track your Order
                        </a>
                      </li>
                      <li
                      ...
                      <li
                        ...
                        className="listf"
                      >
                        <a href="https://demo3.madrasthemes.com/electro/v2/contact-v2/">
                          Returns/Exchange
                        </a>
                      </li>
                      <li
